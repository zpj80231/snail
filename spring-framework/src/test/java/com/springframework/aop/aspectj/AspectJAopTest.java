...
public class AspectJAopTest {
    ...
    public void aspectJExpressionPointcutTest() throws NoSuchMethodException {
        AspectJExpressionPointcut pointcut =
                new AspectJExpressionPointcut("execution(* com.springframework.beans.factory.bean.Cat.*(..))");
    ...
    public void aopProxyTest() {
        AspectJExpressionPointcut pointcut =
                new AspectJExpressionPointcut("execution(* com.springframework.beans.factory.bean.Animal.*(..))");
