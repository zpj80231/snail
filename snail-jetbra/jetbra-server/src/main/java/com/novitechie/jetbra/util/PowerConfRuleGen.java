package com.novitechie.jetbra.util;
...
public class PowerConfRuleGen {
    ...
    public static void main(String[] args) throws Exception {
        ...
        X509Certificate cert = (X509Certificate) certificateFactory.generateCertificate(crtResource.getInputStream());
        ...
        BigInteger r = new BigInteger(1, cert.getSignature()).modPow(certPublicKey.getPublicExponent(), certPublicKey.getModulus());

        System.out.printf("EQUAL,%s,%s,%s->%s%n\n", x, y, z, r);
    }
